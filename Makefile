...
STRING_SRC := ft_strmapi.c ft_split.c ft_strchr.c ft_strdup.c ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strncmp.c ft_strnstr.c ft_strrchr.c ft_strtrim.c ft_substr.c ft_strisnum.c
...
MATH_SRC := ft_abs.c ft_round.c ft_min.c ft_max.c
...
SRC := $(LIST) $(FILE) $(MEM) $(STRING) $(UTILS) $(MATH)
OBJ = $(SRC:.c=.o)
